...
1. **Download the notebook:**
    ...
    ```
    wget https://github.com/PursuitOfDataScience/uchicago-workshops/blob/main/llm-rag/RAG.ipynb
    ```
...
The notebook is designed to be executed on Midway3.  
    ...
    - **Step 2:** To run `RAG.ipynb`, activate the `transformers` conda environment by executing:  
    ```
    module load python/anaconda-2022.05; source activate pytorch;
    ```
